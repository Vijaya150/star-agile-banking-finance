    ...
    stages {
        stage('Build') {
            steps {
                ...
                git 'https://github.com/Vijaya150/star-agile-banking-finance.git'
       ...
       stage('Create Docker Image') {
           steps {
               sh 'docker build -t vijayadarshini/banking-project-demo:1.0 .'
                    }
                }
       stage('Docker-Login') {
           steps {
       ...
       stage('Push-Image') {
           steps {
               sh 'docker push vijayadarshini/banking-project-demo:1.0'
                     }
                }
